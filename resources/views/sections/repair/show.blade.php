...
@section('content')
    ...
    <div id="responsiveWith" class="col-md-9">
        <div class="d-flex justify-content-center">
            <h1 class="mt-5 mr-2 mb-5 borderBottom">مدیریت تعمیرات خودرو<span style="font-size: 27pt;color: tomato;font-style: italic;text-shadow: rgba(72, 63, 21, 0.51)1px 1px;letter-spacing: 2px;font-weight: bolder">{{$car->name}}</span></h1>
        </div>
